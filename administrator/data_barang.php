...
<div class="card mt-2">
	<div class="card-body">
		...
		<a href="printbrg.php" target="printbrg.php" type="button" class="btn btn-success btn-sm">
			Print Data
        </a>
	</div>
	...
	<div class="card-body">
		...
		<table class="table table-bordered" style="border: 1px solid black;">
			<thead>
				...
				<th class="table-danger"style="border: 1px solid black;"><center>Nama Produk</center></th>
				<th class="table-danger"style="border: 1px solid black;"><center>Harga</center></th>
				<th class="table-danger"style="border: 1px solid black;"><center>Stok</center></th>
