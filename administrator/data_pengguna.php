        ...
        <div class="card-body">
           ...
           <table class="table table-bordered" style="border: 1px solid black;">
                <thead>
					...
					<th class="table-danger" style="border: 1px solid black;"><center>Nama Petugas</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Username<center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Akses Petugas</center></th>
