...
<div class="card mt-2">
	...
	<div class="card-body">
		...
		<table class="table table-bordered" style="border: 1px solid black;">
			<thead>
				<tr>
					<th class="table-danger" style="border: 1px solid black;"><center>No</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>ID Pelanggan</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Nama Pelanggan</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>No. Telepon</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Alamat</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Total Pembayaran</center></th>
					<th class="table-danger" style="border: 1px solid black;"><center>Aksi</center></th>
				</tr>
			</thead>
			<tbody>
				<?php 
				...
				while($d = mysqli_fetch_array($data)){
					...
					<tr>
						...
						<td>
							<a class="btn btn-info btn-sm" href="detail_pembelian.php?PelangganID=<?php echo $d['PelangganID']; ?>"><i class="fa-solid fa-circle-info"></i> Detail</a>
							<button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#edit-data<?php echo $d['PelangganID']; ?>"><i class="fa-solid fa-pen-to-square"></i> Edit
							</button>
							<button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus-data<?php echo $d['PelangganID']; ?>"><i class="fa-solid fa-trash"></i>
								Hapus
							</button>
						</td>
					</tr>
