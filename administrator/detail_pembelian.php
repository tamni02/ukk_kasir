		...
		while($d = mysqli_fetch_array($data)){
			...
			<?php if ($d['PelangganID'] == $PelangganID) { ?>
				...
				<form method="post" action="tambah_detail_penjualan.php">
					...
					<button type="submit" class="btn btn-primary btn-sm mt-2"><i class="fa-solid fa-plus"></i> Tambah Barang</button>
				</form>
				<table class="table">
					<thead>
						<tr>
								...
								<tr>
									...
									<td>
										...
										<td>
											...
											<input type="text" name="DetailID" value="<?php echo $d_detailpenjualan['DetailID']; ?>" hidden>
											<input type="text" name="PelangganID" value="<?php echo $d['PelangganID']; ?>" hidden>
											<button type="submit" class="btn btn-warning btn-sm"><i class="fa-solid fa-signal"></i> Proses</button>
										</div>
										</form>
				...
				<form method="post" action="simpan_total_harga.php">
					...
					<div class="row">
						...
						<div class="col-sm-2">
							<div class="form-group">
								<button class="btn btn-info btn-sm form-control" type="submit"><i class="fa-solid fa-bookmark"></i> Simpan</button>
							</div>
						</div>
					</div>
				</form>
